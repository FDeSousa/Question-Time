...
public class QuestionTime extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CURRENT_QUESTION_NUMBER = (TextView) findViewById(R.id.question_questionNumber);
		CURRENT_QUESTION_TEXT = (TextView) findViewById(R.id.question_currentQuestion);
		ANSWER_BUTTON_1 = (Button) findViewById(R.id.question_answer1);
